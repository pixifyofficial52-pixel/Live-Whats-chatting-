...
// ========== UPDATED: Add user to list with crown guarantee ==========
...
function updateUserStatus(userId, isOnline) {
    ...
    statusEl.innerHTML = `<i class="fas fa-circle" style="font-size:8px; margin-right:4px; color:${statusColor};"></i> ${statusText}`;
...
// ========== UPDATED: Special user socket handler ==========
socket.on('user-special-updated', (data) => {
    ...
    // Remove and re-add user to refresh display
